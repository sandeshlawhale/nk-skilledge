  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-xl border bg-white shadow-xs p-6 flex flex-col justify-between h-32">
        ...
        <div className="md:col-span-2 rounded-xl border bg-linear-to-r from-indigo-600 to-purple-600 shadow-lg text-white p-6 relative overflow-hidden flex flex-col justify-center">
          <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-2xl -mr-10 -mt-10" />
          <h3 className="text-lg font-bold mb-1">Continue Learning</h3>
          <p className="text-indigo-100 text-sm mb-4">Advanced React Patterns - Module 4</p>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={course.id} className="rounded-xl border bg-white shadow-xs overflow-hidden flex flex-col">
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <div className="mt-auto space-y-4">
                  ...
                  <Button variant={course.progress === 100 ? 'outline' : 'default'} className={`w-full ${course.progress !== 100 ? 'bg-indigo-600 hover:bg-indigo-700' : ''}`}>
