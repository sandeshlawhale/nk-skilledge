        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex-1 space-y-8">
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-none p-8 border border-slate-200 shadow-none space-y-6">
                <div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4 border-t border-slate-50">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-sm font-bold text-slate-900 uppercase">Lifetime</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 pt-4">
                <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight flex items-center gap-3">
                  <LayoutList className="h-6 w-6 text-primary" /> What you'll learn
                </h2>
