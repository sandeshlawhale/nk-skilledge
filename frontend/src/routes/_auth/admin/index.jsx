    ...
    <div className="space-y-8 max-w-6xl mx-auto">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          <div key={i} className="border bg-white shadow-xs p-6">
            ...
            <div className="flex items-baseline justify-between">
              ...
              <span className="text-xs font-semibold text-green-600 bg-green-100 px-2 py-1">{stat.trend}</span>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
        <div className="border bg-white shadow-xs p-6">
          <h3 className="font-bold text-slate-900 mb-4">Recent Registrations</h3>
          <div className="space-y-4">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="flex items-center justify-between border-b pb-4 last:border-0 last:pb-0">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 bg-slate-100 flex items-center justify-center font-bold text-slate-600">S{i}</div>
                  <div>
        ...
        <div className="border bg-white shadow-xs p-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-center justify-between border-b pb-4 last:border-0 last:pb-0">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-16 bg-slate-100 overflow-hidden">
